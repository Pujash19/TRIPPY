...
const HotelSlider = ({ hotel }: props) => {
  return (
    ...
    transition-all duration-300 object-cover group-hover:scale-110"
        />
      </div>
      {/*text-content*/}
      <h1
        className="mt-4 text-lg font-semibold text-blue-950 hover:text-black cursor-pointer transition-all
      duration-200"
      >
        {hotel.name}
      </h1>
